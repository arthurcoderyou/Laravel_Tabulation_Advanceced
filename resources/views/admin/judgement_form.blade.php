          ...
          <table class="table table-light no-wrap text-center" >
            ...
            <tbody>
              ...
              @foreach($contestants as $contestant)
                ...
                <form action="/admin/judgement/create/{{ $contest->id }}/{{ $judge->id }}/{{ $contestant->id }}" method="post" class="text-center">
                  @csrf
                  @foreach($criterias as $criteria)
                  ...
                  <td>
                    <a href="/admin/judgement/delete/{{ $contest->id }}/{{ $judge->id }}/{{ $contestant->id }}" class="btn text-light {{ !($checked) ? 'disabled btn-outline-danger': 'btn-danger'}}" {{ !($checked) ? 'disabled': ''}}> Reset</a>
