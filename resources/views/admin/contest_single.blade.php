    ...
    @if(auth()->user()->role == 'admin')
        <div class="row">
            ...
            <div class="w-75 my-4 mx-auto">
              ...
              <h1 class="text-dark display-3" style="">{{ $contest->contest_name }}</h1> 
                    ...
                    <table class="table table-light no-wrap" id="table">
                      <legend>{{ $contest->name }}</legend>
                        <thead style="text-align:center;">
                            <tr>
                                <th class="border-top-0">Contestant Name</th>
                                @empty($judges)
                                  <th class="border-top-0">No Judges</th>
                                @else
                                  @foreach($judges as $judge)

                                    <th class="border-top-0">{{ $users[($judge->user_id - 1)]->name }}</th>
                                  @endforeach
                                @endempty
                            </tr>
                        </thead>
